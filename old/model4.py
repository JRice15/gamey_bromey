...
def main():
    ...
    a2 = int(input("a2: "))
    t2 = int(input("t2: "))
    print("Equation1:", equation1(a1, t1, a2, t2))


def equation1(a1, t1, a2, t2):
    if t2 % 2 == 0:
        answer = even1(a1, t1, a2, t2)
    else:
        answer = odd1(a1, t1, a2, t2)
    return answer


# original; works for even t2
def even1(a1, t1, a2, t2):
    A = a1 + a2
    T = t1 + t2
